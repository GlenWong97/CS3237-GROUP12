...
dict = {0: 'NOD', 1: 'SHAKE', 2: 'LOOKUP', 3: 'TILT'} # head gesture no idle
# dict = {0: 'IDLE', 1: 'NOD', 2: 'SHAKE', 3: 'LOOKUP', 4: 'TILT'} # head gesture with idle
# dict = {0: 'RAISE', 1: 'WAVE', 2: 'CLAP'} # hand gesture no idle
# dict = {0: 'IDLE', 1: 'RAISE', 2: 'WAVE', 3: 'CLAP'} # hand gesture with idle
